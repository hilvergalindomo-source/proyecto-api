{
  "info": {
    "_postman_id": "e0a3b808-66cf-4f03-b907-3fef7f4953ff",
    "name": "API Aula POO - Coleccion",
    "description": "Coleccion Postman v2.1 para probar CRUD de usuarios, productos y health.",
  ...
  "item": [
    ...
    },
    {
      ...
      "item": [
        ...
        {
          "name": "POST Usuario Invalido (400)",
          "request": {
            "method": "POST",
            "header": [
              {
        ...
        {
          "name": "GET Usuario No Existe (404)",
          "request": {
            "method": "GET",
            "header": [],
            "url": {
              "raw": "{{baseUrl}}/usuarios/99999",
              "host": [
                "{{baseUrl}}"
              ],
              "path": [
    ...
    },
    {
      ...
      "item": [
        ...
        {
          "name": "POST Producto Invalido (400)",
          "request": {
            "method": "POST",
            "header": [
              {
        ...
        {
          "name": "GET Producto No Existe (404)",
          "request": {
            "method": "GET",
            "header": [],
            "url": {
              "raw": "{{baseUrl}}/productos/99999",
              "host": [
                "{{baseUrl}}"
              ],
              "path": [
